...
当たり判定の確認
円が絡むもの(円同士)、楕円同士→(変形)楕円と円)を実装
円同士の当たり判定にするかという判定を作る。(矩形と同じ考え方)

マウスカーソルの当たり判定について、点だと判定がシビアになりそうだから、半径が1.5くらいの円にして、中心位置をマウスの位置にする

楕円とその他の図形から。checkEllipseAndLineCollide(多分)を修正する
*/
